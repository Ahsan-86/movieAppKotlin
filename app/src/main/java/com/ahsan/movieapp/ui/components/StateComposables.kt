...
/**
 * A slim banner that slides in whenever the device has no internet, so cached content never
 * looks like a silent failure — the person always knows *why* they're seeing saved data.
 */
@Composable
